...
import { PostKeyboardShortcuts } from "@/features/project/components/post-keyboard-shortcuts"
import { LLMCopyButtonWithViewOptions } from "@/features/project/components/post-page-actions"
import { PostShareMenu } from "@/features/project/components/post-share-menu"
import {
  findNeighbour,
  getAllPosts,
  getPostBySlug,
} from "@/features/project/data/posts"
...
export default async function Page({
  ...
  return (
    <>
      ...
      <PostKeyboardShortcuts basePath="/project" previous={previous} next={next} />
...
function getPostUrl(post: Post) {
  ...
  return isComponent ? `/components/${post.slug}` : `/project/${post.slug}`
}
